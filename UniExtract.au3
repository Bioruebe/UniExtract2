...
Func CreateGUI()
	...
	; Create GUI
	If $StoreGUIPosition Then
		Global $guimain = GUICreate($title, 310, 135, $posx, $posy, -1, BitOR($WS_EX_ACCEPTFILES, $iTopmost? $WS_EX_TOPMOST: 0))
	Else
		Global $guimain = GUICreate($title, 310, 135, -1, -1, -1, BitOR($WS_EX_ACCEPTFILES, $iTopmost? $WS_EX_TOPMOST: 0))
	EndIf
